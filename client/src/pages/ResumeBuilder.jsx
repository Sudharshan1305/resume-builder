        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
                ...
                <div className="flex items-center">
                  {activeSectionIndex !== 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 px-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${activeSectionIndex === sections.length - 1 && 'opacity-50'
                      }`}
              ...
              <button
                onClick={() => { toast.promise(saveResume(), { loading: 'Saving...', success: 'Saved successfully' }) }} className="bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm"
              >
                Save Changes
              </button>
